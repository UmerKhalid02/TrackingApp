...
{
    public class UserPagedList<T> : List<T>
    {
        public UserPagedList(IEnumerable<T> items, int count, UserPageParamter pageParams)
        {
        ...
        public static UserPagedList<T> CreateAsync(IQueryable<T> source, UserPageParamter pageParams)
        {
            ...
            return new UserPagedList<T>(items, count, pageParams);
        }
